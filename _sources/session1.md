...
## Aim  
The aim of this session is to learn the Python programming language syntax and its core programming concepts and 
...
These notes are designed with all the details you would need to be able to perform the exercises in this session. In 
...
run these examples as you progress through the notes.  
